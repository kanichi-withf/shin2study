...
import WorldCountryShape from '@/components/WorldCountryShape';
...
function areaIdToQuizId(area: AreaId): QuizId {
  return `world-shape-${area}` as QuizId;
}
...
export default function WorldShapeAreaPage({
  params,
}: {
    ...
    return (
      <main className="quiz-page">
        <div className="qstart">
          <Link href="/quiz/world-shape" className="qstart__back">
            ← もどる
          </Link>
    ...
    (answer: string, isCorrect: boolean) => {
      ...
      setState((prev) => {
        ...
        const entry: AttemptQuestion | null = c
          ? { code: c.code, name: c.name, selected: answer, isCorrect }
          : null;
        return {
          ...prev,
          phase: 'feedback',
    ...
    return (
      <main className="quiz-page">
        ...
        >
          ...
          <div className="qstart__card">
            <span className="qstart__emoji">🧩</span>
            <h1 className="qstart__title">{areaMeta.name} かたち クイズ</h1>
    ...
    <main className="quiz-page">
      <div className="quiz-layout">
        ...
        <section className="quiz-section quiz-section--question">
          ...
          <p className="quiz-question__text">この かたちは どこの くに？</p>
          <div className="quiz-map quiz-map--country-shape">
            <WorldCountryShape code={state.currentCountry?.code ?? null} />
          </div>
        </section>
        ...
        {state.phase === 'feedback' &&
          ...
          (() => {
            const isCorrect =
              state.selectedAnswer === state.currentCountry.name;
