...
export default function WorldAreaQuizPage({
  params,
}: {
    ...
    return (
      <main className="quiz-page">
        <div className="qstart">
          <Link href="/quiz/world-map" className="qstart__back">
            ← もどる
          </Link>
    ...
    return (
      <main className="quiz-page">
        ...
        >
          ...
          <Link href="/quiz/world-map" className="qstart__back" aria-label="もどる">
            ← もどる
          </Link>

          <div className="qstart__card">
            <span className="qstart__emoji">{areaMeta.emoji}</span>
            <h1 className="qstart__title">{areaMeta.name} クイズ</h1>
            <p className="qstart__desc">くにの なまえを あてよう！</p>
    ...
    <main className="quiz-page">
      <div className="quiz-layout">
        ...
        <section className="quiz-section quiz-section--question">
          ...
          <p className="quiz-question__text">この くには どこ？</p>
        ...
        {state.phase === 'feedback' &&
          ...
          (() => {
            const isCorrect = state.selectedAnswer === state.currentCountry.name;
